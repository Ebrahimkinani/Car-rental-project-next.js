...
export default function CarSearchBar({ onSearch }: CarSearchBarProps) {
  ...
  function handleReset() {
    ...
    if (onSearch) {
      onSearch({ carName: "", carModel: "" });
    }
  }

  return (
    <section className="w-full pt-10 pb-10">
      <h2 className="text-center text-[32px] font-semibold mb-8">
        Drive the car of your Dream
      </h2>

      <form
        onSubmit={handleSubmit}
        className="mx-auto flex w-full max-w-4xl flex-col gap-3 md:flex-row md:items-center md:justify-center"
      >
        {/* Custom Search */}
        <Field label="Search">
          <input
